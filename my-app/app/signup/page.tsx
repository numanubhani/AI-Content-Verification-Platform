  ...
  return (
    <div className="mx-auto max-w-md">
      ...
      >
        ...
        <button className="w-full rounded-full bg-purple-600 px-4 py-2 text-white hover:bg-purple-700">Create account</button>
        ...
        <div className="text-sm text-center">
          ...
          <Link className="text-purple-600 hover:underline" href="/login">Log in</Link>
        </div>
      </form>
    </div>
  );
